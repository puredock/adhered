...
const Audit = () => {
    ...
    const regulatoryFrameworks = [
        {
            ...
            description:
                'Health Insurance Portability and Accountability Act - ensures protection of sensitive patient health information',
            category: 'Medical',
            icon: Hospital,
        ...
        },
        {
            ...
            name: 'IEC 62443',
            description:
                'Industrial automation and control systems security standards for operational technology environments',
            category: 'Industrial',
            icon: Building2,
        ...
        },
        {
            ...
            name: 'DO-178C',
            description:
                'Software considerations in airborne systems and equipment certification for aviation safety',
            category: 'Aviation',
            icon: Plane,
        ...
        },
        {
            ...
            description:
                'Framework for improving critical infrastructure cybersecurity across public and private sectors',
            category: 'Public',
            icon: Shield,
        ...
        },
        {
            ...
            name: 'EN 50159',
            description:
                'Railway applications - Communication, signaling and processing systems security standards',
            category: 'Railway',
            icon: Train,
        ...
        },
        {
            ...
            name: 'TAPA FSR',
            description:
                'Transported Asset Protection Association Facility Security Requirements for logistics and supply chain',
            category: 'Logistics',
            icon: Truck,
    ...
    const filteredFrameworks = regulatoryFrameworks.filter(framework => {
        ...
        const matchesTags =
            selectedTags.length === 0 || framework.tags.some(tag => selectedTags.includes(tag))
        const matchesStatus =
            selectedStatuses.length === 0 || selectedStatuses.includes(framework.status)
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Regulatory frameworks and compliance workflows
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        {regulatoryFrameworks.filter(f => f.status === 'active').length}
                                    </p>
                                </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        {regulatoryFrameworks.filter(f => f.status === 'pending').length}
                                    </p>
                                </div>
                ...
                <Card className="shadow-card border-border">
                    <CardHeader>
                        ...
                        <CardDescription>
                            ...
                            {filteredFrameworks.length !== 1 ? 's' : ''} found
                                    ...
                                    <Link key={framework.id} to={`/audits/${framework.id}`}>
                                        <div className="p-5 rounded-lg bg-card border border-border hover:border-primary hover:bg-accent/30 transition-all cursor-pointer group h-full">
                                            <div className="flex items-start justify-between mb-4">
                                                <div
                                                    className={`w-12 h-12 rounded-lg flex items-center justify-center ${framework.iconColor} group-hover:scale-110 transition-transform`}
                                                >
                                    ...
                                    <Link key={framework.id} to={`/audits/${framework.id}`}>
                                        <div className="p-4 rounded-lg bg-card border border-border hover:border-primary hover:bg-accent/30 transition-all cursor-pointer group">
                                            <div className="flex items-center gap-4">
                                                <div
                                                    className={`w-12 h-12 rounded-lg flex items-center justify-center ${framework.iconColor} group-hover:scale-110 transition-transform flex-shrink-0`}
                                                >
                                                    <framework.icon className="w-6 h-6" />
                                                </div>
