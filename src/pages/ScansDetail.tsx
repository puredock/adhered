...
const ScansDetail = () => {
    ...
    const standardsData: Record<string, any> = {
        ...
        'nist-800-115': {
            ...
            completionRate: 78,
            overview:
                'NIST SP 800-115 provides technical guidance for conducting security assessments. It covers review techniques, target identification and analysis techniques, and attack techniques for security testing and examinations.',
            phases: [
        ...
        osstmm: {
            ...
            completionRate: 88,
            overview:
                'OSSTMM is a peer-reviewed methodology for thorough security testing. It focuses on operational security metrics and provides a scientific methodology for accurately characterizing operational security.',
            phases: [
        ...
        'pci-dss': {
            ...
            completionRate: 95,
            overview:
                'PCI DSS penetration testing requirements ensure that organizations handling cardholder data maintain a secure environment. This includes network-layer and application-layer penetration testing at least annually.',
            phases: [
            ...
            <div className="min-h-screen bg-background flex items-center justify-center">
                <Card className="w-96">
                    <CardHeader>
                        ...
                        <CardDescription>
                            The requested penetration testing standard could not be found.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
