...
const Scans = () => {
    ...
    const filteredStandards = useMemo(() => {
        return pentestingStandards.filter(standard => {
            ...
            const matchesStatus =
                selectedStatuses.length === 0 || selectedStatuses.includes(standard.status)
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Penetration testing standards and security assessments
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
            ...
            <main className="container mx-auto px-6 py-8">
                                        ...
                                        <div className="flex items-center justify-between text-sm">
                                            ...
                                            {scan.vulnerabilities.length > 0 && (
                                                <span className="text-destructive font-medium">
                                                    {scan.vulnerabilities.length} vulnerabilit
                                                    {scan.vulnerabilities.length !== 1 ? 'ies' : 'y'}{' '}
                                                    found
                                                </span>
                                            )}
                                        </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        {pentestingStandards.filter(s => s.status === 'active').length}
                                    </p>
                                </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        {pentestingStandards.filter(s => s.severity === 'high').length}
                                    </p>
                                </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-3xl font-bold">
                                        {pentestingStandards.filter(s => s.status === 'pending').length}
                                    </p>
                                </div>
                ...
                <Card className="shadow-card border-border">
                    <CardHeader>
                        ...
                        <CardDescription>
                            {filteredStandards.length} standard
                            {filteredStandards.length !== 1 ? 's' : ''} found
                                    ...
                                    <Link key={standard.id} to={`/scans/${standard.id}`}>
                                        <div className="p-5 rounded-lg bg-card border border-border hover:border-primary hover:bg-accent/30 transition-all cursor-pointer group h-full">
                                            <div className="flex items-start justify-between mb-4">
                                                <div
                                                    className={`w-12 h-12 rounded-lg flex items-center justify-center ${standard.iconColor} group-hover:scale-110 transition-transform`}
                                                >
                                    ...
                                    <Link key={standard.id} to={`/scans/${standard.id}`}>
                                        <div className="p-4 rounded-lg bg-card border border-border hover:border-primary hover:bg-accent/30 transition-all cursor-pointer group">
                                            <div className="flex items-center gap-4">
                                                <div
                                                    className={`w-12 h-12 rounded-lg flex items-center justify-center ${standard.iconColor} group-hover:scale-110 transition-transform flex-shrink-0`}
                                                >
                                                    <standard.icon className="w-6 h-6" />
                                                </div>
