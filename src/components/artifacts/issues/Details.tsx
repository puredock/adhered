            ...
            <div className="flex gap-3 py-2">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                        <p className="text-sm">
                            <span className={cn('font-medium', getStatusColorClass(entry.status))}>
...
export interface IssueDetailViewProps {
    ...
    /** Save inline edits for a section */
    onSaveSection?: (issueId: string, updates: SectionUpdate) => void
        ...
        <div className="flex flex-col h-full bg-background text-foreground">
                ...
                <ScrollArea className="flex-1">
                    <div className="px-6 py-5 min-h-[360px]">
                        ...
                        <TabsContent value="overview" className="mt-0 space-y-6">
                            ...
                            {/* Description content - inline editable */}
                            <section>
                                <InlineEditableText
                                    value={issue.description}
                                    onSave={value => {
                                        onSaveSection?.(issue.id, { description: value })
                                        setEditingSection(null)
                                    }}
                                    isEditing={editingSection === 'description'}
                                    onEditStart={() => setEditingSection('description')}
                        ...
                        <TabsContent value="remediate" className="mt-0 space-y-6">
                            ...
                            {/* Combined remediation content - summary + steps */}
                            <section>
                                <InlineEditableRemediation
                                    ...
                                    onEditStart={() => setEditingSection('remediation')}
                                    onEditEnd={() => setEditingSection(null)}
                                />
                            </section>
            ...
            <div className="flex-shrink-0 border-t border-border bg-muted/30 px-6 py-3 max-h-[280px] flex flex-col">
                ...
                {issue.review_history && issue.review_history.length > 0 ? (
                    ...
                    <p className="text-xs text-muted-foreground mb-3">No review activity yet</p>
                )}
