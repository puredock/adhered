              ...
              <TooltipProvider key={item.title}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      className={cn(
                        "flex items-center gap-3 px-3 py-2 min-h-10 rounded-md text-sm transition-colors text-sidebar-foreground opacity-90 hover:opacity-100 hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground w-full text-left whitespace-nowrap",
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      cn(
                        "flex items-center gap-3 px-3 py-2 min-h-10 rounded-md text-sm transition-colors w-full whitespace-nowrap",
                        isActive
                          ? "bg-sidebar-accent text-sidebar-accent-foreground opacity-100"
                          : "text-sidebar-foreground opacity-90 hover:opacity-100 hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground",
                        isCollapsed && "justify-center px-0"
                      )
                    }
                  >
