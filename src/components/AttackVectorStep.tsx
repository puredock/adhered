...
import { CheckCircle2, Loader2, XCircle, ChevronRight, ChevronDown, AlertCircle, Info, RotateCw, Ban } from "lucide-react";
...
export function AttackVectorStep({ stepIndex, stepName, status, logs, severity = "medium", scanId, onCancel }: AttackVectorStepProps) {
